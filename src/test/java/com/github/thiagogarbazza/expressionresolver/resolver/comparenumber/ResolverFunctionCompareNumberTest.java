...
public class ResolverFunctionCompareNumberTest {
  ...
  public void verifyResolverEquals() {
    ...
    assertEquals(toBigDecimal("0"), resolverFunctionCompareNumber.resolver(left, right));
  }
  ...
  public void verifyResolverGreater() {
    ...
    assertEquals(toBigDecimal("1"), resolverFunctionCompareNumber.resolver(left, right));
  }
